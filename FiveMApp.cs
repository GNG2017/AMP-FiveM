...
namespace FiveMModule
{
    ...
    public class FiveMApp : AppServerBase, IApplicationWrapper, IHasReadableConsole, IHasWriteableConsole
    {
        ...
        public class FiveMVersion
        {
            ...
            {
                return $"URL: {Url}, Release: {Release}";
            }
        }
        ...
        private static new List<ApplicationState> ValidStates = new List<ApplicationState>() { ApplicationState.Starting, ApplicationState.Ready, ApplicationState.Stopping };
